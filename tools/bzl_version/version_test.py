...
class RepoVersionTests(unittest.TestCase):
    """Test that the `rules_vhdl` versions match for WORKSPACE and bzlmod."""
    ...
    def test_versions(self) -> None:
        ...
        version_bzl = rlocation(runfiles, "rules_vhdl/version.bzl")
        ...
        module_bazel = rlocation(runfiles, "rules_vhdl/MODULE.bazel")
